    ...
    <div className='w-full md:w-1/3 text-left'>
      ...
      <div className='flex justify-center sm:block'>
        <a
          ...
          className='font-general-medium flex justify-center items-center w-36 sm:w-48 mt-12 mb-6 sm:mb-0 text-lg border border-ternary-light dark:border-ternary-dark py-2.5 sm:py-3 shadow-lg rounded-lg bg-primary-light focus:ring-1 focus:ring-indigo-900 hover:bg-secondary-dark text-gray-500 hover:text-white duration-500'
